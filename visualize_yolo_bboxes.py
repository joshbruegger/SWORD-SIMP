...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", dest="output_path", nargs='?', const=True, help="Path to save the visualization image or flag to save with default name", default=None)
    args = parser.parse_args()

    if args.output_path is True:
        args.output_path = os.path.join(os.path.dirname(args.image_path), f"visualization_{os.path.basename(args.image_path)}")
